...
class LixoPilha {
  ...
  public LixoPilha proxLIX; // Aponta a celula prox.
   ...
   */
  public LixoPilha(String elemento) {
...
class CelulaPilha {
   ...
   * @param elemento int inserido na celula.
   */
  public CelulaPilha(String elemento) {
...
class Pilha {
  ...
  private CelulaPilha primeiro;
  private CelulaPilha ultimo;
  private CelulaPilha topo;
  private LixoPilha primeiroL;
  private LixoPilha ultimoL;

  public Pilha() {

    topo = null;
    primeiroL = new LixoPilha();
    ultimoL = primeiroL;
  }
  ...
  public void inserirLixo(String entrada) {
    ultimoL.proxLIX = new LixoPilha(entrada);
    ultimoL = ultimoL.proxLIX;
  }

  public void mostrarLixo() {
    for (LixoPilha i = primeiroL.proxLIX; i != null; i = i.proxLIX) {
  ...
  public int tamanho() {
    int tamanho = 0;
    for (CelulaPilha i = primeiro; i != ultimo; i = i.prox, tamanho++)
      ;
    return tamanho;
  }
}

class SeriePilhaFLEX {
